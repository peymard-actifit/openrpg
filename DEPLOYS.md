...
## v0.13.2 - 22/12/2025 01:57:09 
 
- **Type**: patch 
- **Message**: Fix dǸs + Drag  
- **Fichiers modifiés**: 6 
...
- **Type**: patch 
- **Message**: Touche Entree fonctionne pour confirmer le message + Echap pour annuler 
- **Fichiers modifiés**: 2 
...
- **Type**: patch 
- **Message**: Toggle correction automatique en haut a droite 
- **Fichiers modifiés**: 3 
...
- **Type**: patch 
- **Message**: Focus automatique sur zone de reponse apres chaque message IA 
- **Fichiers modifiés**: 6 
- **Rapport**: [2025-12-24_19h01m57s_v1.0.2.txt](logs/deploys/2025-12-24_19h01m57s_v1.0.2.txt) 
...
- **Type**: patch 
- **Message**: Nouveau prompt cable style Abercrombie + API admin stats 
...
- **Type**: patch 
- **Message**: Fix import manquant TypingIndicator 
- **Fichiers modifiés**: 3 
...
- **Type**: patch 
- **Message**: Admin: clarification icone copie partie (clipboard) 
- **Fichiers modifiés**: 2 
